if shared.ArisExecuted then
	...
	local arisAssetTable = {
		["aris/assets/AddItem.png"] = "rbxassetid://13350763121",
		["aris/assets/AddRemoveIcon1.png"] = "rbxassetid://13350764147",
	...
	searchbaricon.Image = downloadArisAsset("aris/assets/SearchBarIcon.png")
	...
	searchbarshadow.Image = downloadArisAsset("aris/assets/WindowBlur.png")
	...
	searchbaricon2.Image = downloadArisAsset("aris/assets/LegitModeIcon.png")
	...
	LegitModulesExitButton.Image = downloadArisAsset("aris/assets/ExitIcon1.png")
	...
	LegitModulesFrameShadow.Image = downloadArisAsset("aris/assets/WindowBlur.png")
	...
	LegitModulesFrameIcon.Image = downloadArisAsset("aris/assets/ProfilesIcon.png")
	...
	hoverboxshadow.Image = downloadArisAsset("aris/assets/WindowBlur.png")
	...
	GuiLibrary.SaveSettings = function()
		if loadedsuccessfully then
			writefile(baseDirectory.."Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".arisprofiles.txt", httpService:JSONEncode(GuiLibrary.Profiles))
			local WindowTable = {}
			...
			writefile(baseDirectory.."Profiles/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".arisprofile.txt", httpService:JSONEncode(GuiLibrary.Settings))
			writefile(baseDirectory.."Profiles/"..(game.GameId).."GUIPositions.arisprofile.txt", httpService:JSONEncode(WindowTable))
		end
	end

	GuiLibrary.LoadSettings = function(customprofile)
		if isfile("aris/Profiles/GUIPositions.arisprofile.txt") and game.GameId == 2619619496 then
			writefile("aris/Profiles/"..(game.GameId).."GUIPositions.arisprofile.txt", readfile("aris/Profiles/GUIPositions.arisprofile.txt"))
			if delfile then delfile("aris/Profiles/GUIPositions.arisprofile.txt") end
		end
		if shared.VapePrivate then
			if isfile("arisprivate/Profiles/"..(game.GameId).."GUIPositions.arisprofile.txt") == false and isfile("aris/Profiles/"..(game.GameId).."GUIPositions.arisprofile.txt") then
				writefile("arisprivate/Profiles/"..(game.GameId).."GUIPositions.arisprofile.txt", readfile("aris/Profiles/"..(game.GameId).."GUIPositions.arisprofile.txt"))
			end
			if isfile("arisprivate/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".arisprofiles.txt") == false and isfile("aris/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".arisprofiles.txt") then
				writefile("arisprivate/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".arisprofiles.txt", readfile("aris/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".arisprofiles.txt"))
			end
		end
		local success2, result2 = pcall(function()
			return httpService:JSONDecode(readfile(baseDirectory.."Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".arisprofiles.txt"))
		end)
		...
		if shared.VapePrivate then
			if isfile("arisprivate/Profiles/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".arisprofile.txt") == false and isfile("aris/Profiles/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".arisprofile.txt") then
				writefile("arisprivate/Profiles/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".arisprofile.txt", readfile("aris/Profiles/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".arisprofile.txt"))
			end
		end
		local success3, result3 = pcall(function()
			return httpService:JSONDecode(readfile(baseDirectory.."Profiles/"..(game.GameId).."GUIPositions.arisprofile.txt"))
		end)
		...
		local success, result = pcall(function()
			return httpService:JSONDecode(readfile(baseDirectory.."Profiles/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".arisprofile.txt"))
		end)
	...
	GuiLibrary["SwitchProfile"] = function(profilename)
		...
		if (not isfile(baseDirectory.."Profiles/"..(profilename == "default" and "" or profilename)..(shared.CustomSaveVape or game.PlaceId)..".arisprofile.txt")) then
	...
	GuiLibrary["CreateMainWindow"] = function()
		...
		windowshadow.Image = downloadArisAsset("aris/assets/WindowBlur.png")
		...
		windowlogo1.Image = downloadArisAsset("aris/assets/VapeLogo1.png")
		...
		windowlogo2.Image = downloadArisAsset("aris/assets/VapeLogo2.png")
		...
		settingswheel.Image = downloadArisAsset("aris/assets/SettingsWheel1.png")
		...
		discordbutton.Image = downloadArisAsset("aris/assets/DiscordIcon.png")
		...
		settingsexit.Image = downloadArisAsset("aris/assets/ExitIcon1.png")
		...
		overlaysicon.Image = downloadArisAsset("aris/assets/TextGUIIcon4.png")
		...
		overlaysexit.Image = downloadArisAsset("aris/assets/ExitIcon1.png")
		...
		overlaysbutton.Image = downloadArisAsset("aris/assets/TextGUIIcon2.png")
		...
		windowbackbutton.Image = downloadArisAsset("aris/assets/BackIcon.png")
		...
		windowapi["CreateCustomToggle"] = function(argstable)
			...
			buttonicon.Image = downloadArisAsset(argstable["Icon"])
			...
			toggleicon.Image = downloadArisAsset(argstable["Icon"])
		...
		windowapi["CreateDivider2"] = function(text)
			...
			if text then
				...
				arrow.Image = downloadArisAsset("aris/assets/RightArrow.png")
				arrow.Active = false
				arrow.Parent = button
				...
				windowbackbutton2.Image = downloadArisAsset("aris/assets/BackIcon.png")
				...
				windowapi3["CreateToggle"] = function(argstable)
					...
					buttonarrow.Image = downloadArisAsset("aris/assets/ToggleArrow.png")
				...
				windowapi3["CreateSlider"] = function(argstable)
					...
					slider3.Image = downloadArisAsset("aris/assets/SliderButton1.png")
		...
		windowapi["CreateGUIBind"] = function()
			...
			bindimg.Image = downloadArisAsset("aris/assets/KeybindIcon.png")
			...
			bindtext2.Image = downloadArisAsset("aris/assets/BindBackground.png")
			...
			bindbkg.MouseEnter:Connect(function() 
				bindimg.Image = downloadArisAsset("aris/assets/PencilIcon.png") 
		...
		windowapi["CreateColorSlider"] = function(name, temporaryfunction)
			...
			sliderrainbow.Image = downloadArisAsset("aris/assets/RainbowIcon1.png")
			...
			slider3.BorderSizePixel = 0
			slider3.ZIndex = 2
			slider3.Image = downloadArisAsset("aris/assets/ColorSlider1.png")
			...
			sliderexpand.Image = downloadArisAsset("aris/assets/HoverArrow3.png")
			sliderexpand.Parent = frame
			sliderexpand.MouseEnter:Connect(function()
				sliderexpand.Image = downloadArisAsset("aris/assets/HoverArrow4.png")
			end)
			...
			sliderapi["SetValue"] = function(hue, sat, val)
				...
				sat = sat or 0.96
				val = val or 0.52
				slider3.Image = ((sliderapi["RainbowValue"] or sliderapi["Custom"]) and downloadArisAsset("aris/assets/ColorSlider2.png") or downloadArisAsset("aris/assets/ColorSlider1.png"))
				sliderrainbow.Image = (sliderapi["RainbowValue"] and downloadArisAsset("aris/assets/RainbowIcon2.png") or downloadArisAsset("aris/assets/RainbowIcon1.png"))
	...
	GuiLibrary["CreateCustomWindow"] = function(argstablemain)
		...
		windowicon.Image = downloadArisAsset(argstablemain["Icon"])
		...
		expandbutton.Image = downloadArisAsset("aris/assets/PinButton.png")
		...
		optionsbutton.Image = downloadArisAsset("aris/assets/MoreButton3.png")
		...
		windowapi["CreateCircleWindow"] = function(argstablemain3)
			...
			targeticon.Image = downloadArisAsset("aris/assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			targeticon.ZIndex = 2
			...
			windowicon.Image = downloadArisAsset("aris/assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			...
			windowapi3["CreateCircleTextList"] = function(argstable)
				...
				textboxbkg.Image = downloadArisAsset((argstable["Name"] == "ProfilesList" and "aris/assets/TextBoxBKG2.png" or "aris/assets/TextBoxBKG.png"))
				...
				addbutton.Image = downloadArisAsset("aris/assets/AddItem.png")
				...
				textGuiLibrary["RefreshValues"] = function(tab, tab2)
					...
					for i,v in pairs(textGuiLibrary["ObjectList"]) do
						...
						deletebutton.Image = downloadArisAsset("aris/assets/AddRemoveIcon1.png")
			...
			--[[windowapi3["CreateButton"] = function(argstable)
				...
				buttonimage.Image = downloadArisAsset(argstable["Icon"])
				...
				buttontexticon.Image = downloadArisAsset(argstable["Icon"])
		...
		windowapi["CreateDropdown"] = function(argstable)
			...
			expandbutton2.Image = downloadArisAsset("aris/assets/DownArrow.png")
			...
			drop2.ExpandButton2.Image = downloadArisAsset("aris/assets/UpArrow.png")
			local thing = Instance.new("Frame")
			thing.Size = UDim2.new(1, 2, 1, 2)
			thing.BorderSizePixel = 0
			thing.Position = UDim2.new(0, -1, 0, -1)
	...
	GuiLibrary["CreateWindow"] = function(argstablemain2)
		...
		windowicon.Image = downloadArisAsset(argstablemain2["Icon"])
		windowicon.Name = "WindowIcon"
		windowicon.BackgroundTransparency = 1
		windowicon.Position = UDim2.new(0, 10, 0, 13)
		windowicon.ImageColor3 = Color3.fromRGB(200, 200, 200)
		...
		expandbutton2.Active = false
		expandbutton2.Size = UDim2.new(0, 9, 0, 4)
		expandbutton2.Image = downloadArisAsset("aris/assets/UpArrow.png")
		...
		windowapi["CreateOptionsButton"] = function(argstablemain)
			...
			button2.Image = downloadArisAsset("aris/assets/MoreButton1.png")
		...
		--	children2.LayoutOrder = amount
			...
			buttonapi["ToggleButton"] = function(clicked, toggle)
				...
				if buttonapi["Enabled"] then
					...
					button2.Image = downloadArisAsset("aris/assets/MoreButton2.png")
			...
			buttonapi["CreateTextList"] = function(argstable)
				...
				textboxbkg.Position = UDim2.new(0, 10, 0, 5)
				textboxbkg.ClipsDescendants = true
				textboxbkg.Image = downloadArisAsset("aris/assets/TextBoxBKG.png")
				textboxbkg.Parent = frame
				local textbox = Instance.new("TextBox")
				textbox.Size = UDim2.new(0, 159, 1, 0)
				textbox.Position = UDim2.new(0, 11, 0, 0)
			...
			buttonapi["CreateTargetWindow"] = function(argstablemain3)
				...
				local windowicon = Instance.new("ImageLabel")
				windowicon.Size = UDim2.new(0, 18, 0, 16)
				windowicon.Image = downloadArisAsset("aris/assets/TargetIcon.png")
				windowicon.ImageColor3 = Color3.fromRGB(200, 200, 200)
				windowicon.ZIndex = 3
				windowicon.Name = "WindowIcon"
				windowicon.BackgroundTransparency = 1
				...
				buttonreturned["Players"] = windowapi["CreateButton"]({
					...
					["Icon"] = "aris/assets/TargetIcon1.png",
					["IconSize"] = 15,
				...
				buttonreturned["NPCs"] = windowapi["CreateButton"]({
					...
					["Icon"] = "aris/assets/TargetIcon2.png",
					["IconSize"] = 12,
					["Function"] = function() end,
					["Default"] = false
				})
				buttonreturned["Peaceful"] = windowapi["CreateButton"]({
					...
					["Icon"] = "aris/assets/TargetIcon3.png",
					["IconSize"] = 16,
					["Function"] = function() end,
					["Default"] = false
				})
				buttonreturned["Neutral"] = windowapi["CreateButton"]({
					...
					["Icon"] = "aris/assets/TargetIcon4.png",
					["IconSize"] = 19,
					["Function"] = function() end,
					["Default"] = false
				})
			...
			buttonapi["CreateTwoSlider"] = function(argstable)
				...
				text4.Image = downloadArisAsset("aris/assets/SliderArrowSeperator.png")
				...
				slider3.BackgroundColor3 = Color3.fromRGB(26, 25, 26)
				slider3.BorderSizePixel = 0
				slider3.Image = downloadArisAsset("aris/assets/SliderArrow1.png")
	...
	GuiLibrary["CreateWindow2"] = function(argstablemain)
		...
		settingsbutton.Image = downloadArisAsset("aris/assets/SettingsWheel2.png")
		...
		windowapi["CreateColorSlider"] = function(argstable)
			...
			sliderexpand.BackgroundTransparency = 1
			sliderexpand.Position = UDim2.new(0, textService:GetTextSize(text1.Text, text1.TextSize, text1.Font, Vector2.new(10000, 100000)).X + 3, 0, 6)
			sliderexpand.Image = downloadArisAsset("aris/assets/HoverArrow.png")
			sliderexpand.Parent = frame
			sliderexpand.MouseEnter:Connect(function()
				sliderexpand.Image = downloadArisAsset("aris/assets/HoverArrow2.png")
			end)
			sliderexpand.MouseLeave:Connect(function()
				sliderexpand.Image = downloadArisAsset("aris/assets/HoverArrow.png")
			end)
	...
	GuiLibrary["CreateNotification"] = function(top, bottom, duration, customicon)
		...
		image.Image = downloadArisAsset("aris/assets/NotificationBackground.png")
		...
		frame2.ZIndex = 2
		frame2.Image = downloadArisAsset("aris/assets/NotificationBar.png")
		frame2.BorderSizePixel = 0
		frame2.Parent = image
		local icon = Instance.new("ImageLabel")
		icon.Name = "IconLabel"
		icon.Image = downloadArisAsset(customicon and "aris/"..customicon or "aris/assets/InfoNotification.png")
